...
# python manage.py test --keepdb routine.tests.TestSearchRoutines

class TestSearchRoutines(TokenHeaderTest):
    ###############################################
    # protected values
    _url, _method = "/api/routines/", "GET"
